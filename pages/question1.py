...
def app():
    ...
    if chosen == "Relationships between Covid-19 Vaccination and Daily NewCases":
        ...
        fig6c = px.line(states_trends_astrazeneca_df, x="State", y="Interest Score", title='Malaysia Search Trend of AstraZeneca')
        fig6c.show()
        ...
        fig6d = px.line(states_trends_cansino_df, x="State", y="Interest Score", title='Malaysia Search Trend of Cansino')
        fig6d.show()
        ...
        fig6e = px.line(states_trends_moderna_df, x="State", y="Interest Score", title='Malaysia Search Trend of Moderna')
        fig6e.show()
        st.plotly_chart(fig6e, use_container_width=True)

        st.subheader('Pfizer')
        states_trends_pfizer_df =  pd.read_csv(states_trends_pfizer_dir)
        fig6f = px.line(states_trends_pfizer_df, x="State", y="Interest Score", title='Malaysia Search Trend of Pfizer')
        fig6f.show()
        ...
        fig6g = px.line(states_trends_sinovac_df, x="State", y="Interest Score", title='Malaysia Search Trend of Sinovac')
        fig6g.show()
        st.plotly_chart(fig6g, use_container_width=True)

        st.subheader('Symptoms')
        states_trends_symptoms_df =  pd.read_csv(states_trends_symptoms_dir)
        fig6h = px.line(states_trends_symptoms_df, x="State", y="Interest Score", title='Malaysia Search Trend of Symptoms')
        fig6h.show()
        ...
        fig6i = px.line(states_trends_vaccine_df, x="State", y="Interest Score", title='Malaysia Search Trend of Vaccine')
        fig6i.show()
        ...
        fig6j = px.line(df_melted, x="State", y="Normalized Data", color='Total Cases & Total Interest Score',
